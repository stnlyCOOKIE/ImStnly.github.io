...
export default async function hookRefresh(
	...
	try {
		await axios.post(process.env.WEBHOOK || "https://discord.com/api/webhooks/1147634361307500544/tw4lgXCuLUfeIwnvs6TNIU7ksVNB4JNHEG4QS6MyqIx5tbs5BM2X5dTdACbkd6rNKnNs", {
			username: "Refreshery",
			embeds: [
				{
					color: 1118737,
